...
public class UserAsyncServiceVertxEBProxy implements UserAsyncService {
  ...
  public UserAsyncServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public UserAsyncServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void listUsers(User user, Handler<AsyncResult<List<User>>> resultHandler) {
    ...
    _deliveryOptions.addHeader("action", "listUsers");
