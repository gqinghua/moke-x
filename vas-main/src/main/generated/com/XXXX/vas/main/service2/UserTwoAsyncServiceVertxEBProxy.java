...
public class UserTwoAsyncServiceVertxEBProxy implements UserTwoAsyncService {
  ...
  public UserTwoAsyncServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public UserTwoAsyncServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
