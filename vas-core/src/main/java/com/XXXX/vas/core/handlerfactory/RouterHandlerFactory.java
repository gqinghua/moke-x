package com.XXXX.vas.core.handlerfactory;
...
import com.XXXX.vas.core.utils.ReflectionUtil;
import com.XXXX.vas.core.vertx.RouterUtil;
            ...
            if (method.isAnnotationPresent(RouteMapping.class)) {
                ...
                switch (routeMethod) {
                    ...
                    case ROUTE:
                        ...
                        break;
                    case GET: // go through the default
                    default:
